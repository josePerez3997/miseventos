...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, SessionListComponent]
})
export class EventDetailComponent implements OnInit {
  ...
  get isOrganizer(): boolean {
    if (!this.isAuthenticated || !this.event || !this.authService.currentUser) return false;
    return this.event.organizerId === this.authService.currentUser.id;
  }
  ...
  formatDateRange(startDate: Date, endDate?: Date): string {
    ...
    if (!endDate || start.toDateString() === (endDate instanceof Date ? endDate : new Date(endDate)).toDateString()) {
